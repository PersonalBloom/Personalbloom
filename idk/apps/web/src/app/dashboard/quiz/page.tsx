...
const QUESTION_BANK: Record<string, { q: string; options: string[]; correct: number }[]> = {
  Math: [
    ...
    { q: 'What is the value of π (pi) to 2 decimal places?', options: ['3.12', '3.14', '3.16', '3.41'], correct: 1 },
    ...
    { q: 'What is the area of a circle with radius 5? (use π ≈ 3.14)', options: ['15.7', '31.4', '78.5', '25π'], correct: 2 },
  ...
  Biology: [
    ...
    { q: 'What does the term "diploid" mean?', options: ['One set of chromosomes', 'Two sets of chromosomes', 'No chromosomes', 'Three sets of chromosomes'], correct: 1 },
  ...
  Chemistry: [
    ...
    { q: 'What is a catalyst?', options: ['A substance consumed in the reaction', 'A substance that speeds up a reaction without being used up', 'A reactant', 'A product'], correct: 1 },
    { q: 'Which group of the periodic table contains the noble gases?', options: ['Group 1', 'Group 7', 'Group 0/18', 'Group 2'], correct: 2 },
    ...
    { q: 'What is Avogadro's number approximately?', options: ['6.02 × 10²³', '3.14 × 10⁸', '9.81 × 10⁶', '1.67 × 10⁻²⁷'], correct: 0 },
  ],
  Physics: [
    ...
    { q: 'What is Newton's second law?', options: ['F = mv', 'F = ma', 'F = m/a', 'F = m + a'], correct: 1 },
    ...
    { q: 'What is Ohm's law?', options: ['V = IR', 'V = I/R', 'V = I + R', 'I = VR'], correct: 0 },
    ...
    { q: 'In a series circuit, what happens to current?', options: ['It is different at each point', 'It is the same throughout', 'It increases with each resistor', 'It becomes zero'], correct: 1 },
    { q: 'What is work done equal to?', options: ['Mass × velocity', 'Force × distance', 'Power × time', 'Pressure × area'], correct: 1 },
    { q: 'What is the electromagnetic spectrum ordered by (lowest to highest frequency)?', options: ['Gamma, X-ray, UV, visible, IR, microwave, radio', 'Radio, microwave, IR, visible, UV, X-ray, gamma', 'Visible, UV, IR, radio, gamma, X-ray', 'Microwave, radio, IR, UV, visible, gamma, X-ray'], correct: 1 },
  ],
  History: [
    ...
    { q: 'What was the name of the policy of racial segregation in South Africa?', options: ['Segregationism', 'Colonialism', 'Apartheid', 'Nationalism'], correct: 2 },
    ...
    { q: 'What was the name of the US nuclear bombing project in WWII?', options: ['Operation Overlord', 'The Manhattan Project', 'Operation Barbarossa', 'Project Mercury'], correct: 1 },
    { q: 'Which country first landed a man on the moon?', options: ['USSR', 'China', 'USA', 'UK'], correct: 2 },
    { q: 'What was the Cold War?', options: ['A war fought in Antarctica', 'Political tension between USA and USSR without direct military conflict', 'A war about oil in the Middle East', 'A trade dispute between Europe and Asia'], correct: 1 },
    ...
    { q: 'What was the Great Depression?', options: ['A literary movement in the 1900s', 'A global economic crisis starting in 1929', 'A period of drought in the 1940s', 'A war in Latin America'], correct: 1 },
  ...
  English: [
    ...
    { q: 'What does "omniscient narrator" mean?', options: ['A narrator who only knows one character's thoughts', 'A narrator who knows everything about all characters', 'A narrator who is also a character', 'A narrator who is unreliable'], correct: 1 },
    { q: 'What is alliteration?', options: ['Repetition of vowel sounds', 'Repetition of consonant sounds at the start of words', 'A word that sounds like what it means', 'Exaggeration'], correct: 1 },
    ...
    { q: 'What is the difference between first and third person narration?', options: ['First uses "he/she", third uses "I"', 'First uses "I", third uses "he/she/they"', 'They are the same', 'First person is always unreliable'], correct: 1 },
    { q: 'What is dramatic irony?', options: ['When the audience knows something the characters don't', 'When two characters say the same thing', 'When a character says the opposite of what they mean', 'When something unexpected happens'], correct: 0 },
  ...
  Economics: [
    { q: 'What is GDP?', options: ['Gross Domestic Product — total value of goods/services produced in a country', 'Government Debt Percentage', 'Global Development Plan', 'Gross Debt Position'], correct: 0 },
    ...
    { q: 'What happens to demand when price rises (ceteris paribus)?', options: ['Demand rises', 'Demand falls', 'Demand stays the same', 'Supply rises'], correct: 1 },
    ...
    { q: 'What is a fiscal policy?', options: ['Central bank control of interest rates', 'Government use of taxation and spending to influence the economy', 'Control of money supply', 'Exchange rate policy'], correct: 1 },
    ...
    { q: 'What is a market equilibrium?', options: ['When demand exceeds supply', 'When supply exceeds demand', 'When quantity demanded equals quantity supplied', 'When the government sets prices'], correct: 2 },
